...
class UserDomainModule(
    ...
    fun getUserListFlowUseCase(): GetUserListFlowUseCase =
        GetUserListFlowUseCase(userRepository)
    fun addUserUseCase(): AddUserUseCase =
        AddUserUseCase(userRepository)
    fun editUserUseCase(): EditUserUseCase =
        EditUserUseCase(userRepository)
    fun deleteUserByIdUseCase(): DeleteUserByIdUseCase =
        DeleteUserByIdUseCase(userRepository)
    fun blockUserUseCase(): ToggleBlockUserUseCase =
        ToggleBlockUserUseCase(userRepository)
    fun getUserByIdUseCase(): GetUserByIdUseCase =
        GetUserByIdUseCase(userRepository)
    fun getUserByPhone(): IsPhoneUniqueUseCase =
