...
fun ArticleCard(
    ...
    Card(
        ...
        Column(
            ...
            ArticleText(
                title = article.title,
                text = article.description ?: stringResource(R.string.article_dont_have_description),
                imageUrl = article.imageUrl ?: "",
                articleUrl = article.link,
                articleSource = article.sourceName,
                articleSourceIconUrl = article.sourceIconUrl ?: "",
                author = article.creator ?: article.sourceName,
...
@Composable
private fun CategoryDateInfo(category: NewsCategory, date: LocalDateTime) {
    Row(
