package com.zagirlek.splash.elements
...
@Composable
internal fun SpinningLoader(
    modifier: Modifier = Modifier,
    stickColor: Color = MaterialTheme.colorScheme.onBackground
) {
    ...
    Canvas(modifier = modifier) {
        ...
        for (i in 0 until 12){
            ...
            rotate(
                ...
                drawRoundRect(
                    color = stickColor.copy(alpha = alphaForThisStick),
